...
import { DiHtml5, DiCss3, DiJavascript1, DiReact, DiPhp, DiGit, DiJava} from 'react-icons/di';
...
const Skills = () => {
  ...
  <li className="flex flex-col items-center bg-gray-800 p-4 rounded-lg shadow-md hover:bg-gray-700 transition">
    <DiJava className="text-6xl text-[#007396] mb-2" />
    <span className="text-white text-sm mt-1">Java</span>
  </li>
  <li className="flex flex-col items-center bg-gray-800 p-4 rounded-lg shadow-md hover:bg-gray-700 transition">
  ...
  <li className="flex flex-col items-center bg-gray-800 p-4 rounded-lg shadow-md hover:bg-gray-700 transition">
    ...
    <span className="text-white text-sm mt-1">Tailwind</span>
  </li>
  <li className="flex flex-col items-center bg-gray-800 p-4 rounded-lg shadow-md hover:bg-gray-700 transition">
    <SiVuedotjs className="text-6xl text-emerald-500 mb-2" />
    <span className="text-white text-sm mt-1">Vue</span>
  </li>
