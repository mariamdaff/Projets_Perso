...
import { DiHtml5, DiCss3, DiJavascript1, DiReact, DiPhp, DiGit, DiTailwind } from 'react-icons/di';
...
const Skills = () => {
  ...
  <DiTailwind title="Tailwind" className="hover:text-blue-500 transition"/>
