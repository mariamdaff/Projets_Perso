...
import { DiHtml5, DiCss3, DiJavascript1, DiReact, DiPhp, DiGit, SiTailwindcss, SiVuedotjs } from 'react-icons/di';
...
const Skills = () => {
  ...
  <SiVuedotjs title="Vue.js" className="hover:text-green-400 transition" />
