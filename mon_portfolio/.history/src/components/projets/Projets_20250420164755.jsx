...
const Projets = () => {
  const projets = [
    ...
    { id: 3, titre: 'Littoral Propore', description: 'Back-Office pour une association qui collecte des dechets sur la plage.' },
    { id: 4, titre: 'PushMyCode ', description: ' Microblogging de dev qui permet aux dev de se partager des astuces de code' },
    { id: 5, titre: 'Mobile-front', description: 'Description du projet 5' },
