...
const Projets = () => {
  const projets = [
    {
      ...
      image: '/assets/img/quiz-game.png',
    ...
    },
    {
      ...
      image: '/assets/img/meteo-app.png',
      link: 'https://github.com/tonprofil/meteo-app'
    },
    {
      id: 3,
  ...
  return (
    <section className="py-12 px-4 bg-black text-white grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
